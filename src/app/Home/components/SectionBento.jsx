  ...
  function Bento() {
    return (
      ...
      <span className="bg-primary rounded-full h-[600px] w-[600px] blur-[400px] absolute -top-80 left-[35%] z-[-1] opacity-40"></span>
        ...
        <div className='flex gap-5  bg-clip-border'>

                <span className="bg-primary rounded-full h-[250px] w-[50px] blur-[40px] absolute bottom-0 right-0 z-[-1] opacity-80"></span>
          <div className='w-1/2 relative group/1 !overflow-hidden'>
            <div className=' cursor-pointer p-5 backdrop-blur-lg border border-white/10 bg-white/5  hover:border-primary/20 h-80 w-full rounded-xl overflow-hidden '>
          ...
          <div className='flex gap-5 w-1/2'>
            ...
            <div className=' relative  overflow-hidden cursor-pointer p-5 backdrop-blur-lg border border-white/10 bg-white/5 hover:border-primary/20 h-80 w-full rounded-xl  '>
              <div className='grid gap-5 z-10  transition duration-1000  '>
                <div className='flex gap-2  items-center z-10'>
                  <AiFillOpenAI className='text-primary text-3xl z-10' />
...
export default function SectionBento() {
    return (
        ...
        <motion.div style={{
          opacity: 1,
          transition: "all 1s "}}
        className='h-[100vh] snap-center w-full backdrop-blur  relative overflow-hidden bg-black '>
              <div
