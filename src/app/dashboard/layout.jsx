...
export default async function DashboardLayout({ children }) {
    ...
    return (
        <div className=' h-full overflow-hidden   flex justify-between items-center flex-col  bg-gradient-to-b from-primary/20 to-transparent from-1% to-20% transition-all' >
            <div className='bg-[url(/assets/images/3.png)] bg-contain bg-no-repeat bg-center w-[80vw] h-screen absolute top-0 z-[-1] grayscale-40 opacity-60 mask-b-from-0 mix-blend-color-overlay'>
            </div>
